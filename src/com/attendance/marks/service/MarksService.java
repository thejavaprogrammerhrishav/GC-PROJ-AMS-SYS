...
public interface MarksService {
    ...
    public abstract boolean deleteMarks(List<UnitTest> list);

    public abstract List<UnitTest> findAll();

    public abstract List<UnitTest> findByUnitTest(String unitTest);

    public abstract List<UnitTest> findBySemesterAndAcademicyearAndYear(String semester, String academicyesr, String year);
