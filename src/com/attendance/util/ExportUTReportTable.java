...
public class ExportUTReportTable {
    ...
    public ExportUTReportTable(TableView<UTReportModel> list) {
        this.list = list;
        RowCount = 0;
    }

    public ExportUTReportTable createFile() {
    ...
    public ExportUTReportTable convertToExcel(String sheetName) {
        ...
        list.getItems().stream().forEach(at -> {
            ...
            c = Excel.createCell(r, 1, ""+at.getName(), body);
            c = Excel.createCell(r, 2, ""+at.getMarks(), body);
            c = Excel.createCell(r, 3, ""+at.getPassing(), body);
            c = Excel.createCell(r, 4, ""+at.getTotal(), body);
