 ...
 */
public class DeletePaperController extends AnchorPane {
    ...
    public DeletePaperController() {
        ...
        try {
            ...
            Logger.getLogger(DeletePaperController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initialize() {
        ...
        deletepaper.setOnAction(this::delete);
        table.setOnMouseClicked(this::tableClick);
        applyfilter.setOnAction(this::aapply);
    ...
    private void delete(ActionEvent evt) {
        boolean b = dao.delete(paper);
        if (b) {
            MessageUtil.showInformation(Message.INFORMATION, "Delete Paper", "Paper Deleted Successfully", ((Node) evt.getSource()).getScene().getWindow());
        } else {
            MessageUtil.showInformation(Message.ERROR, "Delete Paper", "Paper Deletion Failed", ((Node) evt.getSource()).getScene().getWindow());

        }
    }

    private void aapply(ActionEvent evt) {
