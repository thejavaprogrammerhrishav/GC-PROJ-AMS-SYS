 ...
 */
public class DeleteAdminUserController extends AnchorPane{
     @FXML
    ...
    public DeleteAdminUserController() {
        fxml=Fxml.getDeleteAdminUserFXML();
        fxml.setRoot(this);
        fxml.setController(this);
         ...
         try {
             ...
             Logger.getLogger(DeleteAdminUserController.class.getName()).log(Level.SEVERE, null, ex);
         }
    }
    ...
    private void initialize(){
        ...
        deleteuser.setOnAction(this::delete);
    }
    ...
    private void delete(ActionEvent evt) {
        ...
        if (d) {
            MessageUtil.showInformation(Message.INFORMATION, "Administrator Login Account", "Account Updated Successfully", DeleteAdminUserController.this.getScene().getWindow());
        } else {
            MessageUtil.showError(Message.ERROR, "Administrator Login Account", "Account Updation Failed", DeleteAdminUserController.this.getScene().getWindow());
        }
    }
}
