 ...
 * @author pc
 */
public class FacultyLoginActivityController extends AnchorPane {
    ...
    public FacultyLoginActivityController(LoginActivity activity) {
        this.activity = activity;
        fxml = Fxml.getFacultyLoginActivityFXML();
        fxml.setRoot(this);
        ...
        try {
            ...
            Logger.getLogger(FacultyLoginActivityController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
